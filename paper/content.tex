...
\def\paperstatus{10} % a number from 0-100 indicating your status. 100
                % means completed
\def\paperchapter{Vagrant} % This section is typically a single keyword. from
...
\keywords{\locator\ Use up to 5 keywords, keyword1}
